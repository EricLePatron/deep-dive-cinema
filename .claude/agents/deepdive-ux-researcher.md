---
name: deepdive-ux-researcher
description: Expert UX Research pour Deepdive Cinema. Utiliser pour analyser les comportements des 4 personas (Cinéphile Académique, Explorateur Letterboxd, Programmateur, Curieux en Transition), produire des études synthétiques ou réelles à partir des données Supabase, identifier des frictions UX à partir de l'observation, formuler des hypothèses testables, ou préparer des protocoles de test utilisateur.
