---
name: deepdive-growth
description: Expert Growth, SEO & Distribution pour Deepdive Cinema. Utiliser pour définir la stratégie d'acquisition, analyser le SEO (meta tags, sitemap, structured data, indexation Google), proposer des canaux de distribution, analyser les funnels de conversion, élaborer des stratégies de rétention, identifier des opportunités de partenariats, ou produire un brief growth/SEO actionnable.
...
Référencer dans `robots.txt` : `Sitemap: https://www.deepdive-cinema.com/sitemap.xml`
