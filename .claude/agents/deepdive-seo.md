---
name: deepdive-seo
description: Expert SEO technique et éditorial pour Deepdive Cinema. Utiliser pour auditer l'indexation Google (SPA sans SSR, meta tags dynamiques, JSON-LD, sitemap, canonical), implémenter react-helmet-async, rédiger des synopses SEO optimisés, définir la stratégie de mots-clés longue traîne par film, analyser les données Google Search Console, ou produire un brief d'implémentation SEO avec le code exact.
