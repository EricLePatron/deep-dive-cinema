...
description: Expert Analytics & Data pour Deepdive Cinema. Utiliser pour analyser les métriques produit, construire des requêtes SQL sur les tables Supabase (favorites, consumed_items, video_feedback, letterboxd_profiles, film_content_stats), calculer les KPIs (SAA, WAU, rétention, funnel Letterboxd), identifier les patterns d'engagement, diagnostiquer des problèmes de données, ou produire un rapport analytics.
