---
name: deepdive-ux
description: Expert Product Design et UX pour Deepdive Cinema. Utiliser pour évaluer ou améliorer l'expérience utilisateur, proposer des designs de nouvelles features (avec wireframes textuels), auditer la cohérence du design system (palette noir/blanc, typographie Fraunces/Inter, composants), rédiger des briefs Lovable précis, diagnostiquer des problèmes UX sur une surface existante, ou valider l'impact UX d'une décision technique.
