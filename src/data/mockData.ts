...
export const mockBooks: ContentItem[] = [
  {
    ...
    source: "Titan Books",
    url: "https://www.amazon.com/Art-Soul-Blade-Runner-2049/dp/1785657100",
  ...
  },
  {
    ...
    source: "Del Rey",
    url: "https://www.amazon.com/Do-Androids-Dream-Electric-Sheep/dp/0345404475",
  ...
  },
  {
    ...
    url: "https://www.amazon.com/Future-Noir-Making-Blade-Runner/dp/0062663844",
...
export const mockDocumentaries: ContentItem[] = [
  {
    ...
    source: "Warner Bros",
    url: "https://www.youtube.com/watch?v=hQzDeEtbvME",
    duration: "45 min",
  },
  {
    id: "doc-2",
...
export const mockYouTubeVideos: ContentItem[] = [
  {
    ...
    source: "YouTube",
    url: "https://www.youtube.com/watch?v=hka0LpXqS-c",
    imageUrl: "https://i.ytimg.com/vi/hka0LpXqS-c/maxresdefault.jpg",
  ...
  },
  {
    ...
    source: "YouTube",
    url: "https://www.youtube.com/watch?v=gO-E4F0B-rY",
  ...
  },
  {
    ...
    source: "YouTube",
    url: "https://www.youtube.com/watch?v=tUDL3Mz_jjs",
    channel: "Wisecrack",
    duration: "15:33",
  },
];
...
export const mockPodcasts: ContentItem[] = [
  {
    ...
    url: "https://open.spotify.com/episode/3z0z9g2Qm5Qz5Qz5Qz5Qz5",
    duration: "1h 12min",
    date: "Oct 2017",
  },
  {
    ...
    url: "https://songexploder.net/blade-runner-2049",
    duration: "45 min",
    date: "Nov 2017",
  },
  {
    ...
    source: "Team Deakins",
    url: "https://www.teamdeakins.com/blade-runner-2049",
    duration: "58 min",
    date: "Dec 2017",
  },
];
...
export const mockArticles: ContentItem[] = [
  {
    ...
    url: "https://www.cahiersducinema.com/blade-runner-2049",
  ...
  },
  {
    ...
    source: "IndieWire",
    url: "https://www.indiewire.com/features/craft/blade-runner-2049-production-design-1201886854/",
  ...
  },
  {
    ...
    source: "Variety",
    url: "https://variety.com/2017/film/box-office/blade-runner-2049-box-office-bomb-1202584407/",
    author: "Brent Lang",
    date: "October 2017",
  },
];
...
export const mockInterviews: ContentItem[] = [
  {
    ...
    url: "https://www.hollywoodreporter.com/movies/movie-features/ryan-gosling-blade-runner-2049-interview-1042929/",
    date: "October 2017",
  },
  {
    id: "int-2",
    ...
    url: "https://www.empireonline.com/movies/features/harrison-ford-blade-runner-2049-interview/",
    date: "September 2017",
  },
  {
    id: "int-3",
    ...
    source: "Vanity Fair",
    url: "https://www.vanityfair.com/hollywood/2017/10/ana-de-armas-blade-runner-2049-joi",
    date: "October 2017",
  },
];
